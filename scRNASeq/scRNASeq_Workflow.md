...
10X Raw Data (8 samples)
         ↓
[Preparation Scripts] → 8 Individual Seurat Objects
         ↓
[Step 1: Integration] → suture_mes_raw_20230328.rds
         ↓
[Step 2: Mito Regression] → suture_mes_mito_harmony_20230329.rds
         ↓
[Step 3: MAGIC Imputation] → suture_mes_mito_MAGIC_harmony_20230329.rds
         ↓
[Step 4: Downstream Analysis] → suture_mes_mito_MAGIC_OG_0430.rds
         ↓
[Step 5: Runx2 Analysis] → Final Results & Targets
```
